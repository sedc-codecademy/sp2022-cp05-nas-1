		...
		<>
			...
			<ul>
				<li>
					...
					or &quot;Our&quot; in this Cookies Policy) refers to Newstopia Media Group, Republic of Macedonia.
				</li>
				<li>
				...
				<li>
					<strong>Website</strong> refers to Newstopia, accessible from{' '}
					<a href='https://newstopia.mk' rel='external nofollow noopener' target='_blank'>
						https://newstopia.mk
					</a>
				</li>
				<li>
			...
			<ul>
				<li>By email: contact@newstopia.mk</li>
			</ul>
		</>
	);
}
